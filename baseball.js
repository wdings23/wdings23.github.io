...
function findWasmBinary() {
    return locateFile('baseball.wasm');
}
...
// Begin JS library code
  ...
  var _wgpuComputePassEncoderSetLabel = (passId, labelPtr) => {
      var pass = WebGPU.mgrComputePassEncoder.get(passId);
...
var wasmImports = {
  ...
  /** @export */
  wgpuComputePassEncoderSetLabel: _wgpuComputePassEncoderSetLabel,
  /** @export */
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 14695656;
