...
function findWasmBinary() {
    return locateFile('webgpu-ray-tracing-compute.wasm');
}
...
// Begin JS library code
  ...
  var _wgpuBindGroupLayoutSetLabel = (bindGroupLayoutId, labelPtr) => {
  ...
  var _wgpuBindGroupSetLabel = (bindGroupId, labelPtr) => {
  ...
  var _wgpuComputePipelineSetLabel = (pipelineId, labelPtr) => {
      var pipeline = WebGPU.mgrComputePipeline.get(pipelineId);
  ...
  var _wgpuPipelineLayoutSetLabel = (pipelineLayoutId, labelPtr) => {
  ...
  var _wgpuRenderPipelineSetLabel = (pipelineId, labelPtr) => {
      var pipeline = WebGPU.mgrRenderPipeline.get(pipelineId);
      pipeline.label = UTF8ToString(labelPtr);
    };
...
var wasmImports = {
  ...
  /** @export */
  wgpuBufferSetLabel: _wgpuBufferSetLabel,
  /** @export */
  ...
  /** @export */
  wgpuComputePipelineSetLabel: _wgpuComputePipelineSetLabel,
  /** @export */
  ...
  /** @export */
  wgpuTextureSetLabel: _wgpuTextureSetLabel,
  /** @export */
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 11661088;
